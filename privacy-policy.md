...
본 앱은 **회원가입/로그인 기능이 없으며**, 이용자가 직접 입력하는 개인정보(이름, 이메일 등)를 수집하지 않습니다.

다만 아래 목적을 위해 기기 정보 및 광고 식별자가 자동으로 수집될 수 있습니다.

### 1-1. 게임 진행 데이터 (기기 로컬 저장)
- 맵별 진행 상황(발견한 나나 수, 클리어 여부, 플레이 시간 등)
- **본 데이터는 이용자의 기기 내부에만 저장되며, 외부 서버로 전송되지 않습니다.**
- 앱 삭제 시 함께 삭제됩니다.
...
본 앱은 이용자의 개인정보를 직접 판매하거나 제3자에게 제공하지 않습니다. 다만 아래 서비스 제공을 위해 각 서비스 사업자가 자체적으로 정보를 처리할 수 있습니다.
...
본 앱은 만 14세 미만 아동을 주 대상으로 하지 않으며, 아동으로부터 개인정보를 의도적으로 수집하지 않습니다.
...
본 방침은 법령 또는 서비스 정책 변경에 따라 개정될 수 있으며, 변경 시 본 페이지를 통해 공지합니다.
